...
pub unsafe fn init(phys_memory_offset: VirtAddr) -> OffsetPageTable<'static> {
    let lvl4_table = active_lvl4_table(phys_memory_offset);
    OffsetPageTable::new(lvl4_table, phys_memory_offset)
}
...
unsafe fn active_lvl4_table(phys_memory_offset: VirtAddr) -> &'static mut PageTable {
    active_lvl4_table_inner(phys_memory_offset)
}

fn active_lvl4_table_inner(phys_memory_offset: VirtAddr) -> &'static mut PageTable {
